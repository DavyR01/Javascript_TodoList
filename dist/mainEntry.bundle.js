...
}`, "",{"version":3,"sources":["webpack://./src/style/style.css"],"names":[],"mappings":"AAAA;GACG,qBAAqB;AACxB","sourcesContent":[".container {\r\n   border: 1px solid red;\r\n}"],"sourceRoot":""}]);
// Exports
...
console.log(elem);
var elem2 = document.getElementsByClassName('class-test');
console.log(elem2);
var elem3 = document.getElementsByTagName('img');
console.log(elem3);

// -----------------------------------------------
var elem4 = document.querySelector('#id-2');
console.log(elem4);
var elem5 = document.querySelector('img');
console.log(elem5);
var elem6 = document.querySelectorAll('img');
console.log(elem6);
var elem7 = document.querySelector('img[alt=random2]');
console.log(elem7);

// -----------------------------------------------
var paul = document.querySelector(".employe");
...
var a = document.querySelector("#id-test2");
...
var maDiv = document.getElementById("ma-div");
